        ...
        <div id="home-container">
            ...
            <div className="about-container">
                ...
                <p>I'm a recent Electrical and Electronic Engineering graduate from Imperial College London, and
                    ...
                    The thing I like the most about myself is that I'm never satisfied with what I know - I have to keep
                    learning and using new technologies.
                    <br/><br/>
                    I also enjoy playing the piano and guitar, producing music, snowboarding and wakeboarding, and most
