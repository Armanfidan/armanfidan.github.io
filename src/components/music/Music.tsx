...
export default function Music() {
    ...
    return (
        <div id="home-container"  onTouchStart={handleTouchStart} onTouchMove={handleTouchMove}>
            ...
            <p>
                However, it had not occurred to me until this year to combine this passion for music with technology, in
                electronic music.
                I went to a LOT of electronic music events last year, and realised how much of an effect these sounds
                can have on people.
                I figured this out because of the effect it had on me.
            </p>
            <p>
                This realisation led to me picking up electronic music production.
                After months of learning about this incredible and huge discipline, I realised that I could combine it
                with piano and... a bit of Jazz? Yeah!
            </p>
            <p>
                Thus, now I am focusing my efforts on producing electronic music (mostly tech house) influenced by and
